...
float4 main(VS_OUTPUT input) : SV_TARGET
{
	...
	float4 normalMapSample = normalMap.Sample(sampleLinear, input.UV);
	...
	float4 directLight = ComputeLighting(lights, mat, input.Position.xyz, bumpedNormal, toEyeNormal, shadowFactor);
